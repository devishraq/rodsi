 ...
 * Changes Made
 - Added Evaluation Config for AMC23 & added that to the Tasks Table
 - Added Evaluation Config for Minerva & added that to the Tasks Table
"""
...
def amc_prompt_fn(line, task_name: str = None):
    return aime_prompt_fn(line, task_name=task_name) # Identical with aime prompt function

def minerva_prompt_fn(line, task_name: str = None):
    return math_prompt_fn(line, task_name=task_name)
